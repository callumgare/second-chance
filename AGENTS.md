...
- **Logging**: There are 360+ `print()` calls in the codebase. Prefer routing new logging through `LogManager` (`Utilities/Logger.swift`) or `os.Logger` rather than raw `print()`. Avoid adding `[DEBUG N]` prefixes.
